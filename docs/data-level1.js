/* ============================================================================
 * Verbal Advantage — Level 1 题库（Word 1–50）
 * 来源：[GRE语文优势].Verbal.Advantage.pdf
 *
 * words 里的 50 个核心词即 Level 1 的 50 个 keyword；
...
VA.registerLevel({
 ...
 "words": [
  ...
  },
  {
   ...
   "ipa": "",
   "pos": "v.",
   "def": "To welcome, address with good humor.",
   "zh": "问候，迎接",
   "syn": [],
   "ant": [],
   "note": "",
 ...
 "parts": {
   ...
   "items": [
    {
     ...
     "b": "multifarious",
     "answer": "S",
     "reason": "manifold = multifarious，都是\"多种多样的\"。原书把二者并列为同等难度的同义词。"
    },
    {
     "a": "prudent",
     "b": "cautious",
     "answer": "S",
     "reason": "prudent = 审慎的；cautious = 谨慎的。二者是 Level 1 word 47 的核心近义词。"
    },
    {
     "a": "aloof",
     "b": "gregarious",
     "answer": "A",
     "reason": "aloof（疏远冷漠）↔ gregarious（爱社交、合群）。"
    },
    {
     "a": "adamant",
     "b": "unyielding",
     "answer": "S",
     "reason": "adamant 的释义原句就是 unyielding, immovable, inflexible。"
    },
    {
     "a": "blatant",
     "b": "inconspicuous",
     "answer": "A",
     "reason": "blatant（喧闹、明目张胆、显眼）↔ inconspicuous（不显眼的）。原书：blatant suggests something conspicuous and disagreeable。"
    },
    {
     "a": "peevish",
     "b": "fretful",
     "answer": "S",
     "reason": "peevish = 易怒爱抱怨；fretful = 烦躁不满。原书 Level 1 复习题原句即为 \"fretful and peevish\"。"
    },
    {
     "a": "aloof",
     "b": "standoffish",
     "answer": "S",
     "reason": "aloof 的同义词表里就包含 standoffish（冷淡疏远）。"
    },
    {
     "a": "tawdry",
     "b": "elegant",
     "answer": "A",
     "reason": "tawdry（廉价而花哨、俗气）↔ elegant（优雅的）。"
    },
    {
     "a": "arduous",
     "b": "strenuous",
     "answer": "S",
     "reason": "arduous 的同义词表：strenuous, laborious, toilsome。"
    },
    {
     "a": "congenial",
     "b": "cantankerous",
     "answer": "A",
     "reason": "congenial（性情相投、合得来）↔ cantankerous（爱争吵、难相处）。原书把 congenial 的反义列为 alien / dissident / incongruous，cantankerous 与之同向。"
    }
   ]
  },
  "C": {
  ...
  "D": {
   ...
   "items": [
    ...
    {
     "word": "cantankerous 与 disagreeable 的关系",
     "answer": "b",
