...
| **单词卡** | **一屏 2×5 共 10 张**。**正面只有英文单词**（+音标），**点一下翻面才显示中文释义**、英文释义与同反义词。翻面后可标「已掌握」。支持翻屏、全部翻面、每屏 2/4/6 行、只练未掌握。 |
| **词汇表** | 每级 50 词可搜索的速查表。 |
...
- **单词卡网格**：一屏 10 张、**正面只有英文（不含任何中文或释义）**、逐张翻面互不影响、全部翻面、卡内标「已掌握」后从「只练未掌握」移出、翻屏、每屏数量切换
